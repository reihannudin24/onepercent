...
ALTER TABLE users
ADD COLUMN token_remember VARCHAR(255);
...
ADD COLUMN  start_dates DATE,
ADD COLUMN  end_dates DATE;
...
INSERT INTO schedules (title, description, category, reminder, start_time, end_time,  type, status, user_id) VALUES
('Workout', 'deskripsi schedule', 'plan', 'whatsapp', '08:00:00', '08:00:00',  'none', 'reminder', 1);
